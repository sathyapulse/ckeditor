...
m,b,n);return}v(b,!0)}n&&n(p)})):n&&n(p)},switchOffAutoHideShow(){R=!1},ua:e,getFlashPlayerVersion(){return{major:e.pv[0],minor:e.pv[1],release:e.pv[2]}},hasFlashPlayerVersion:A,createSWF(a,b,c){if(e.w3)return K(a,b,c)},showExpressInstall(a,b,c,d){e.w3&&F()&&G(a,b,c,d)},removeSWF(a){e.w3&&P(a)},createCSS(a,b,c,d){e.w3&&Q(a,b,c,d)},addDomLoadEvent:M,addLoadEvent:N,getQueryParamValue(a){var b=d.location.search||d.location.hash;if(b){/\?/.test(b)&&
(b=b.split("?")[1]);if(null==a)return S(b);for(var b=b.split("\x26"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("\x3d"))==a)return S(b[c].substring(b[c].indexOf("\x3d")+1))}return""},expressInstallCallback(){if(B){var a=p("SWFObjectExprInst");a&&y&&(a.parentNode.replaceChild(y,a),C&&(v(C,!0),e.ie&&e.win&&(y.style.display="block")),I&&I(O));B=!1}}}}();