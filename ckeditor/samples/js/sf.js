...
const SF = (function() {
  ...
  b.indexOf = (function() {
    ...
    return a === 'function'
      ...
      : function(a, b) {
          for (let c = a.length, d = 0; d < c; d++) if (a[d] === b) return d;
          return -1;
        };
  })();
  b.accept = function(a, e) {
    ...
    a.children
      ? ((c = a.children), e(a))
      : typeof a.length === 'number' && (c = a);
    for (let d = c ? c.length || 0 : 0; d--; ) b.accept(c[d], e);
  };
  b.getByClass = (function() {
    const a = document.getElementsByClassName;
    return typeof a === 'function'
      ? function(e, b) {
          typeof e === 'string' && ((b = e), (e = document));
          return a.call(e, b);
        }
      : function(a, c) {
          typeof a === 'string' &&
  ...
  b.classList.remove = function(a, e) {
    let f = d(a, e),
      n = b.indexOf(f, e);
    n !== -1 && (f.splice(n, 1), a.attributes.setNamedItem(c(f)));
  };
  b.classList.contains = function(a, c) {
    return b.indexOf(d(a), c) !== -1;
  };
...
('use strict');
(function() {
  for (let d = SF.getByClass('tree-a'), c = d.length; c--; )
...
(function(d, c) {
  function b(a) {
    return typeof Node === 'object'
      ? a instanceof Node
      : a && typeof a === 'object' && typeof a.nodeType === 'number';
  }
  function a() {
    const a = [];
    return {
  ...
  function n(a, b) {
    ...
    return e
      ...
      .attr('role', 'dialog')
      .onClick(a => {
        new e(a.target).anyAncestor(a =>
          /\bpico-close\b/.test(a.elem.className),
        ) && b();
      });
  }
  function p(a) {
  ...
  function k(c) {
    ...
    if (typeof c === 'string' || b(c)) c = { content: c };
    var x = a(),
      y = a(),
      z = a(),
      w = a(),
  ...
  e.prototype = {
    ...
    stylize(a) {
      a = a || {};
      typeof a.opacity !== 'undefined' &&
        (a.filter = `alpha(opacity\x3d${100 * a.opacity})`);
      for (const b in a) a.hasOwnProperty(b) && (this.elem.style[b] = a[b]);
      return this;
    },
    clazz(a) {
  ...
  typeof d.define === 'function' && d.define.amd
    ? d.define(() => k)
    : (d.picoModal = k);
})(window, document);
