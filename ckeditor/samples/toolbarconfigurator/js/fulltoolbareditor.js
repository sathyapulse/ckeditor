...
(function() {
  ...
  e.prototype.groupButtonNamesByGroup = function(b) {
    ...
    b = e.groupButtons(b);
    for (const d in b)
      b[d] = e.map(b[d], b => a.getCamelCasedButtonName(b.name));
    return b;
  };
  ...
  e.prototype.getCamelCasedButtonName = function(b) {
    let a = this.editorInstance.ui.items,
      d;
  ...
  e.toolbarToButtons = function(b) {
    for (var a = [], d = b.length, c = 0; c < d; c += 1)
      typeof b[c] === 'object' && (a = a.concat(e.groupToButtons(b[c])));
    return a;
  };
  e.createToolbarButton = function(b) {
    ...
    a.addClass(`cke_${CKEDITOR.lang.dir == 'rtl' ? 'rtl' : 'ltr'}`);
  ...
  e.createIcon = function(b, a, d) {
    var c = CKEDITOR.skin.getIconStyle(b, CKEDITOR.lang.dir == 'rtl'),
      c =
        (c = c || CKEDITOR.skin.getIconStyle(a, CKEDITOR.lang.dir == 'rtl')) ||
        CKEDITOR.skin.getIconStyle(d, CKEDITOR.lang.dir == 'rtl');
  ...
  e.createButton = function(b, a) {
    const d = new CKEDITOR.dom.element('button');
    d.addClass('button-a');
    d.setAttribute('type', 'button');
    if (typeof a === 'string') {
      a = a.split(' ');
      for (let c = a.length; c--; ) d.addClass(a[c]);
    }
    d.setHtml(b);
    return d;
  };
