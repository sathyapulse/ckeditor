...
(function() {
  const v = function(d, l) {
    function v() {
      ...
      b && b.commit(...a);
      this.foreach(b => {
        b.commit && b.id != 'txtdlgGenStyle' && b.commit(...a);
      });
    }
    function k(a) {
      if (!w) {
        ...
        if (c) {
          ...
          for (var d = a.length, f, g = 0; g < d; g++)
            (f = b.getContentElement(...a[g].split(':'))) && f.setup(1, c);
        }
        w = 0;
      }
    }
    var m = /^\s*(\d+)((px)|\%)?\s*$/i,
      ...
      A = function() {
        ...
        b.lockRatio &&
          ((c = b.originalElement),
          c.getCustomData('isReady') == 'true' &&
            (this.id == 'txtHeight'
              ? (a && a != '0' && (a = Math.round(a / c.$.height * c.$.width)),
                isNaN(a) || b.setValueOf('info', 'txtWidth', a))
              : (a && a != '0' && (a = Math.round(a / c.$.width * c.$.height)),
      ...
      B = function(a, b) {
        let c = a.originalElement;
        if (c.getCustomData('isReady') == 'true') {
          let d = a.getContentElement('info', 'txtWidth'),
    ...
    return {
      ...
      minWidth:
        (CKEDITOR.skinName || d.config.skin) == 'moono-lisa' ? 500 : 420,
      minHeight: 360,
      onShow() {
        ...
        c &&
          ...
          l == 'image' && this.setupContent(2, c));
        if (this.customImageElement)
          (this.imageEditMode = 'img'),
            (this.imageElement = this.customImageElement),
            delete this.customImageElement;
        else if (
          (b && b.getName() == 'img' && !b.data('cke-realelement')) ||
          (b && b.getName() == 'input' && b.getAttribute('type') == 'image')
        )
      ...
      onOk() {
        if (this.imageEditMode) {
          const a = this.imageEditMode;
          l == 'image' && a == 'input' && confirm(d.lang.image.button2Img)
            ? ((this.imageElement = d.document.createElement('img')),
              this.imageElement.setAttribute('alt', ''),
              d.insertElement(this.imageElement))
            : l != 'image' && a == 'img' && confirm(d.lang.image.img2Button)
      ...
      onLoad() {
        l != 'image' && this.hidePage('Link');
        const a = this._.element.getDocument();
                  ...
                  children: [
                    {
                      ...
                      onChange() {
                        ...
                        if (b.length > 0) {
                          ...
                          const d = CKEDITOR.document.getById(p);
                      ...
                      commit(a, b) {
                        a == 1 && (this.getValue() || this.isChanged())
                  ...
                  children: [
                    {
                      ...
                      children: [
                          ...
                          children: [
                            {
                              ...
                              validate() {
                                let a = this.getValue().match(z);
                                (a = !(!a || parseInt(a[1], 10) === 0)) ||
                        ...
                        },
                        {
                          ...
                          onLoad() {
                            let a = CKEDITOR.document.getById(y),
                          ...
                          }" class\x3d"cke_btn_locked" id\x3d"${t}" role\x3d"checkbox"\x3e\x3cspan class\x3d"cke_icon"\x3e\x3c/span\x3e\x3cspan class\x3d"cke_label"\x3e${
                            d.lang.image.lockRatio
                          }\x3c/span\x3e\x3c/a\x3e\x3ca href\x3d"javascript:void(0)" tabindex\x3d"-1" title\x3d"${
                            d.lang.image.resetSize
                          }" class\x3d"cke_btn_reset" id\x3d"${y}" role\x3d"button"\x3e\x3cspan class\x3d"cke_label"\x3e${
                            d.lang.image.resetSize
                      ...
                      children: [
                        {
                          ...
                          commit(a, b) {
                            const c = parseInt(this.getValue(), 10);
                            a == 1 || a == 4
                              ? (isNaN(c)
                                  ? !c &&
                                    this.isChanged() &&
                  ...
                  children: [
                    {
                      ...
                      id: 'htmlPreview',
                      style: 'width:95%;',
                      html: `\x3cdiv\x3e${CKEDITOR.tools.htmlEncode(
                        d.lang.common.preview,
                      )}\x3cbr\x3e\x3cdiv id\x3d"${p}" class\x3d"ImagePreviewLoader" style\x3d"display:none"\x3e\x3cdiv class\x3d"loading"\x3e\x26nbsp;\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"ImagePreviewBox"\x3e\x3ctable\x3e\x3ctr\x3e\x3ctd\x3e\x3ca href\x3d"javascript:void(0)" target\x3d"_blank" onclick\x3d"return false;" id\x3d"${E}"\x3e\x3cimg id\x3d"${D}" alt\x3d"" /\x3e\x3c/a\x3e${d
  ...
  CKEDITOR.dialog.add('image', d => v(d, 'image'));
  CKEDITOR.dialog.add('imagebutton', d => v(d, 'imagebutton'));
})();
