...
(function() {
  CKEDITOR.dialog.add('link', c => {
    ...
    return {
      title: b.title,
      minWidth:
        (CKEDITOR.skinName || c.config.skin) == 'moono-lisa' ? 450 : 350,
      minHeight: 240,
      contents: [
        {
          id: 'info',
            ...
            },
            {
              ...
              onChange() {
                ...
                for (f = 0; f < b.length; f++) {
                  let h = a.getContentElement('info', b[f]);
                  h &&
                    ((h = h
                      .getElement()
                      .getParent()
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      onKeyUp() {
                        ...
                        let a = this.getDialog().getContentElement(
                            'info',
                            'protocol',
                          ),
                          b = this.getValue(),
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  html: `\x3cdiv role\x3d"note" tabIndex\x3d"-1"\x3e${CKEDITOR.tools.htmlEncode(
                    b.noAnchors,
                  )}\x3c/div\x3e`,
                  focus: !0,
                  setup() {
      ...
      onShow() {
        ...
        f.length <= 1 && n.showDisplayTextForElement(h, a)
          ? c.show()
          : c.hide();
      ...
      onOk() {
        ...
        if (this._.selectedElements.length) {
          ...
          for (k = 0; k < b.length; k++) {
            ...
            else if (d == l || (a.type == 'email' && l.indexOf('@') != -1))
              e =
                a.type == 'email'
                  ? a.email.address
      ...
      onFocus() {
        let a = this.getContentElement('info', 'linkType');
        a &&
          a.getValue() == 'url' &&
