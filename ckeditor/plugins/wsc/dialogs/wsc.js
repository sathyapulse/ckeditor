...
(function() {
  ...
  function I(a) {
    ...
    for (e in a)
      for (const f in a[e]) {
        const h = a[e][f];
        h == 'en_US' ? (d = h) : c.push(h);
      }
    c.sort();
    d && c.unshift(d);
    return {
      getCurrentLangGroup(c) {
        a: {
          for (const e in a)
            for (const d in a[e])
      ...
      setLangList: (function() {
        let c = {},
          e;
        for (e in a) for (const d in a[e]) c[a[e][d]] = d;
        return c;
      })(),
    };
  }
  var g = (function() {
      const a = function(a, b, e) {
        e = e || {};
        let f = e.expires;
      ...
      return {
        postMessage: {
          ...
          send(a) {
            let b = Object.prototype.toString,
              ...
              k = a.message || { id: f };
            a.message &&
              b.call(a.message) == '[object Object]' &&
        ...
        misc: {
          ...
          isVisible(a) {
            let b;
            (b = a.offsetWidth === 0 || a.offsetHeight == 0) ||
              (b =
  ...
  a.framesetHtml = function(b) {
    return `\x3ciframe id\x3d${
      a.iframeNumber
    }_${b} frameborder\x3d"0" allowtransparency\x3d"1" style\x3d"width:100%;border: 1px solid #AEB3B9;overflow: auto;background:#fff; border-radius: 3px;"\x3e\x3c/iframe\x3e`;
  };
  a.setIframe = function(b, c) {
    let d;
    d = a.framesetHtml(c);
    const e = `${a.iframeNumber}_${c}`;
  ...
  a.setHeightBannerFrame = function() {
    let b = a.dialog.getContentElement('SpellTab', 'banner').getElement(),
  ...
  a.buildSelectLang = function(a) {
    let c = new CKEDITOR.dom.element('div'),
  ...
  a.buildOptionLang = function(b, c) {
    let d = document.getElementById(`wscLang${c}`),
  ...
  a.buildOptionSynonyms = function(b) {
    ...
    const c = z(a.selectNode.Synonyms);
  ...
  var B = function(a) {
      ...
      let h = c.getElementById(e),
        k = h || c.createElement('div');
      k.style.cssText = `position: absolute;top:30px;bottom:41px;left:1px;right:1px;z-index: 10020;padding:0;margin:0;background:${a};opacity: ${f};filter: alpha(opacity\x3d${100 *
        f});display: none;`;
      k.id = e;
      h || d.appendChild(k);
      return {
    ...
    L = function(b, c, d) {
      let e = new CKEDITOR.dom.element('div'),
    ...
    O = {
      ...
      thesaurusSuggest(b) {
        ...
        let c = z(a.selectNode.Categories),
          d = 0;
      ...
      settext(b) {
        ...
        const c = a.dialog.getParentEditor();
  ...
  CKEDITOR.dialog.add('checkspell', b => {
    function c(a) {
      let c = parseInt(b.config.wsc_left, 10),
    ...
    function d() {
      ...
      (function(a) {
        let b = {
            ...
            restoreDataFromString(a) {
              ...
              if (typeof a === 'string')
                switch (((b = a.indexOf(this.separator)),
                (c = a.substring(0, b)),
          ...
          c = {
            ...
            set(a, c) {
              const d = b.convertDataToString(c);
          ...
          e = {
            ...
            clear() {
              for (
                let a = document.cookie.split(';'), b = 0;
                b < a.length;
                b++
              ) {
                var c = a[b],
                  d = c.indexOf('\x3d'),
                  c = d > -1 ? c.substr(0, d) : c;
                this.deleteCookie(c);
              }
            },
          },
      ...
      b.wsc.getLocalStorageUD = function() {
        const a = b.wsc.DataStorage.getData('scayt_user_dictionary');
        if (a) return a;
      };
      b.wsc.addWords = function(a, c) {
        let d = `${b.config.wsc.DefaultParams.serviceHost +
            b.config.wsc.DefaultParams
              .ssrvHost}?cmd\x3ddictionary\x26format\x3djson\x26customerid\x3d1%3AncttD3-fIoSf2-huzwE4-Y5muI2-mD0Tt-kG9Wz-UEDFC-tYu243-1Uq474-d9Z2l3\x26action\x3daddword\x26word\x3d${a}\x26callback\x3dtoString\x26synchronization\x3dtrue`,
        ...
        e.onreadystatechange = function() {
          this.readyState === 'loaded' && c();
        };
      };
      b.wsc.cgiOrigin = function() {
        const a = b.config.wsc.DefaultParams.serviceHost.split('/');
        return `${a[0]}//${a[2]}`;
      };
      b.wsc.isSsrvSame = !1;
    }
    var e = function(c) {
        ...
        (f != 'ChangeTo' && f != 'ChangeAll') || b.fire('saveSnapshot');
        f == 'FinishChecking' &&
        ...
        if (CKEDITOR && CKEDITOR.config) {
          ...
          var d =
            ...
            d =
              ...
              `${d}//www.webspellchecker.net/spellcheck3/script/ssrv.cgi?plugin\x3dfck2\x26customerid\x3d${
                a.wsc_customerId
              }\x26cmd\x3dscript\x26doc\x3dwsc\x26schema\x3d22`;
          c(this);
          CKEDITOR.scriptLoader.load(d, c => {
            CKEDITOR.config &&
            CKEDITOR.config.wsc &&
            ...
            b.plugins.scayt &&
              (b.wsc.isSsrvSame = (function() {
                let a = CKEDITOR.config.wsc.DefaultParams.serviceHost
                    .replace('lf/22/js/../../../', '')
                    .split('//')[1],
                ...
                window.SCAYT &&
                  ...
                  (p = `${f
                    .split(`${g}/`)[1]
                    .replace('/lf/scayt3/ckscayt/', '')}/script/ssrv.cgi`));
                !d ||
                  f ||
                ...
                return (
                  `//${a}${c}` ===
                  `//${b.config.scayt_serviceHost || g || e}/${b.config
                    .scayt_servicePath ||
                    p ||
                    h}`
                );
            ...
            if (window.SCAYT && b.wsc && b.wsc.isSsrvSame) {
              ...
              c = function(a) {
                a.origin === e &&
                  ...
                  a.ud && a.ud !== 'undefined'
                    ? (b.wsc.ud = a.ud)
                    : a.ud === 'undefined' && (b.wsc.ud = void 0),
                  a.udn && a.udn !== 'undefined'
                    ? (b.wsc.udn = a.udn)
                    : a.udn === 'undefined' && (b.wsc.udn = void 0),
              ...
              setTimeout(() => {
                const a = b.wsc.getLocalStorageUDN();
        ...
        },
        {
          ...
          elements: [
            ...
            },
            {
              ...
              html: '',
              setup() {
                let b = `${a.iframeNumber}_${a.dialog._.currentTabId}`,
  ...
  CKEDITOR.dialog.add('options', b => {
    ...
    return {
      ...
      onShow() {
        ...
        const b = g.cookie.get('osp').split('');
